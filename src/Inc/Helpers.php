...
if (!function_exists('captcha_img')) {
    function captcha_img($id = 'captcha-img', $class = 'captcha-img', $style = 'height:38px !important; min-height:38px !important; width:110px !important; min-width:85px !important; max-width:120px !important; flex-shrink:0 !important; object-fit:cover !important; cursor:pointer !important; border-radius:6px !important; border:1px solid #ccc !important; background-color:#fff !important; margin:0 !important; padding:0 !important; box-sizing:border-box !important; vertical-align:middle !important; display:inline-block !important;')
    {
        $src = captcha_src();
...
if (!function_exists('captcha_field')) {
    function captcha_field($name = 'captcha', $placeholder = 'Kode Captcha')
    {
        ...
        return '
        <div class="captcha-form-wrapper" style="display:flex !important; flex-direction:row !important; flex-wrap:nowrap !important; align-items:center !important; gap:6px !important; margin:8px 0 !important; font-family:inherit !important; width:100% !important; max-width:100% !important; box-sizing:border-box !important;">
            ' . $img . '
            <span onclick="' . $jsClick . '" title="Refresh Captcha" style="height:38px !important; min-height:38px !important; width:36px !important; min-width:36px !important; flex-shrink:0 !important; display:inline-flex !important; align-items:center !important; justify-content:center !important; background:#f8f9fa !important; border:1px solid #ccc !important; border-radius:6px !important; cursor:pointer !important; color:#333 !important; padding:0 !important; margin:0 !important; outline:none !important; box-sizing:border-box !important; line-height:1 !important;">' . $svgIcon . '</span>
            <input type="text" name="' . $name . '" style="height:38px !important; min-height:38px !important; flex:1 1 0% !important; min-width:0 !important; max-width:100% !important; padding:6px 10px !important; border:1px solid #ccc !important; border-radius:6px !important; font-size:14px !important; line-height:1.4 !important; outline:none !important; box-sizing:border-box !important; background-color:#fff !important; color:#333 !important; margin:0 !important; display:inline-block !important;" placeholder="' . $placeholder . '" required autocomplete="off" maxlength="5" oninput="this.value=this.value.replace(/[^a-zA-Z0-9]/g,\'\')">
        </div>';
    }
}
