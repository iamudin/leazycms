            ...
            <form autocomplete="off" action="{{ $user ? route('user.update', $user->id) : route('user.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="password" name="password" class="form-control" placeholder="Masukkan password" autocomplete="false">
                        ...
                        <small class="text-danger">Minimal 8 karakter dan di butuhkan Min 1 Kapital, 1 huruf kecil, 1 angka dan symbol
                            khusus</small>
                </div>

                <div class="form-group mt-2  mb-2">
                    <label class="mb-0">Konfirmasi Password</label>
                      <input autocomplete="false" class="form-control form-control-sm confirm_password" id="confirm_password" name="password_confirmation" type="password" placeholder="Masukkan ulang password">
