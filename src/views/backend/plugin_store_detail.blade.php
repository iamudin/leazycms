...
<div class="row mb-3">
    <div class="col-12">
        <a href="{{ route('admin.plugins.store') }}" class="btn btn-secondary">
            <i class="fa fa-arrow-left"></i> Kembali ke Plugin Store
        </a>
    </div>
</div>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm sticky-top" style="top: 80px;">
            <div class="card-body text-center">
                @if($template['is_premium'])
                    <p class="text-muted mb-1">Harga Plugin</p>
                ...
                @if($template['is_premium'])
                    @if($template['is_purchased'])
                        <div class="alert alert-success py-2 mb-3">
                            <i class="fa fa-check-circle"></i> Anda sudah membeli plugin ini
                        </div>
                        @if($isActive)
                        ...
                        @elseif($isInstalled)
                            <button type="button" class="btn btn-success btn-lg btn-block toggle-plugin-btn" data-slug="{{ $slug }}" data-action="enable">
                                <i class="fa fa-check"></i> Aktifkan Sekarang
                            </button>
                        @else
