...
@section('content')
    <form class="" action="{{ URL::full() }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 style="font-weight:normal" class="mb-4"> <i class="fa fa-list-alt" aria-hidden="true"></i> {{str($slug)->headline()}}
                    ...
                    @foreach ($data as $field)
                          @if(is_array($field[1]))
                            ...
                            <select name="{{_us($field[0])}}" class="form-control form-control-sm" style="width:250px"  @if (isset($field[2])) required @endif >
