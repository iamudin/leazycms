...
<style>
    ...
    .search-panel .form-control:focus {
        background: white;
        border-color: var(--theme-primary, #4361ee);
    ...
    .btn-outline-modern:hover {
        background: #f8fafc;
        border-color: #cbd5e1;
        color: var(--theme-primary, #4361ee);
    }
    .price-tag {
        font-weight: 800;
        font-size: 0.85rem;
...
<div class="store-hero d-flex justify-content-between align-items-center flex-wrap">
    <div>
        <h2 class="font-weight-bold mb-1"><i class="fa fa-paint-brush mr-2"></i> Cloud Template Store</h2>
        <p class="mb-0 text-white-50">Jelajahi dan temukan desain terbaik untuk website Anda</p>
    </div>
    <div class="mt-3 mt-md-0">
        <a href="{{ route('appearance') }}" class="btn btn-light btn-modern text-primary shadow-sm" style="border-radius: 30px; padding: 10px 20px;">
            <i class="fa fa-arrow-left"></i> Tema Lokal
        </a>
    </div>
</div>
...
<div class="row">
                ...
                <div class="store-card">
                    ...
                    <div class="store-card-body">
                        ...
                        <div class="store-card-footer">
                            <a href="{{ route('appearance.template_detail', $template['id']) }}" class="btn btn-outline-modern btn-modern w-50">
    ...
    @else
        <div class="col-12 text-center py-5 bg-white shadow-sm" style="border-radius: 16px;">
            ...
            <h5 class="text-muted font-weight-bold">Tidak Ada Template</h5>
