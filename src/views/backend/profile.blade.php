                                    ...
                                    @foreach (array_merge(['Sejarah', 'Visi dan Misi', 'Struktur Organisasi'], config('modules.static_menu_profile')) as $key => $page)
                                        <div class="btn-group mr-1 mb-2" role="group">
                                            <a class="btn btn-outline-success btn-sm"
                                                href="{{ route('page.create') }}?slug={{ str($page)->slug() }}" target="_blank">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-sm" name="email"
                                            value="{{ old('email', get_option('email')) }}" placeholder="Masukkan email resmi">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control form-control-sm" name="twitter"
                                    value="{{ old('twitter', get_option('twitter')) }}" placeholder="Link Twitter organisasi">
                            </div>

                            <div class="form-group">
                                <small>YouTube</small>
                                <input type="url" class="form-control form-control-sm" name="youtube"
                                    value="{{ old('youtube', get_option('youtube')) }}" placeholder="Link channel YouTube">
                            </div>
