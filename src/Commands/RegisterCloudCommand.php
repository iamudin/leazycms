...
{
    protected $signature = 'cms:register-cloud';
    ...
    public function handle()
    {
        ...
        try {
            ...
            if ($response->successful() && $response->json('api_key')) {
                ...
                $this->line('Menyimpan konfigurasi ke file .env...');

                $this->createEnvConfig(['CLOUD_TEMPLATE_KEY' => $apiKey]);

                $this->info('Konfigurasi selesai! Anda sekarang dapat mengakses Cloud Template.');
            } else {
